...
namespace _1_Presentacion
{
    public partial class Actualizar_Usuario : Form
    {
        ...
        private void Actualizar_Usuario_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error en el Metodo Actualizar_Usuario_Load", "Ha ocurrido un error en 'Actualizar Usuario'", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnCargar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error en el Metodo btnCargar_Click", "Ha ocurrido un error en 'Actualizar Usuario'", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public void RecibeDatos(int i, string j, string k, string l, string m, string n, string o, decimal p, int q)
        {
            ...
            {
                MessageBox.Show("Error en el Metodo RecibeDatos", "Ha ocurrido un error en 'Actualizar Usuario'", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error en el Metodo btnActualizar_Click", "Ha ocurrido un error en 'Actualizar Usuario'", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void cbotipo2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error en el Metodo cbotipo2_SelectedIndexChanged", "Ha ocurrido un error en 'Actualizar Usuario'", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
